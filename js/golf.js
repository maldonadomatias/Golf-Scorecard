...
// }
//     else{
//         scorecard1.classList.remove("display");
//     }
// });
...
toggleP2.addEventListener("click", function(e) {
  if (!scorecard1.classList.contains("display")) {
    scorecard2.classList.remove("display");
    scorecard1.classList.add("display");
  }
});

closeAlert.addEventListener("click", function(e) {
  if (!inputDetails.classList.contains("display")) {
    inputDetails.classList.add("display");
  }
});
